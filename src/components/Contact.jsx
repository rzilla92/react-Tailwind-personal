    ...
    <section id='contact' className=' bg-brightRed py-16 '>
        <div className='container flex flex-col justify-center  mx-auto px-4 py-10'>
            ...
            <div className='flex-1 flex flex-row justify-center items-center gap-8'>
              <a target='_blank' rel='nonreferrer noopener' className=' cursor-pointer transition-all hover:opacity-75 hover:scale-110 ' href='https://www.linkedin.com/in/sari-putra-gunawan-62666259/'><i class="fa-brands fa-linkedin text-4xl text-white"></i></a>
              <a target='_blank' rel='nonreferrer noopener' className=' cursor-pointer transition-all hover:opacity-75 hover:scale-110 ' href='https://github.com/rzilla92'><i class="fa-brands fa-github text-4xl text-white"></i></a>
              <a target='_blank' rel='nonreferrer noopener' className=' cursor-pointer transition-all hover:opacity-75 hover:scale-110 ' href='https://www.instagram.com/royzilla92/'><i class="fa-brands fa-instagram text-4xl text-white"></i></a>
