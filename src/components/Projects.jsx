  ...
  return (
    <section id='projects' className=' bg-veryPaleRed py-16'>
        <div className='container flex flex-col justify-center mx-auto px-4 py-10'>
            ...
            <div className='flex-1 flex flex-col md:flex-row md:flex-wrap justify-center gap-8'>
                <div className="flex-[35%] rounded overflow-hidden bg-white shadow-lg transition-all hover:scale-105 hover:cursor-pointer">
